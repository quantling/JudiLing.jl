...
@testset "output tests for latin" begin
    ...
    JudiLing.save_S_matrix(S_train, "S_train.txt", latin_train, :Word)
    JudiLing.save_S_matrix(S_val, "S_val.txt", latin_val, :Word)

    S_train_load, Words = JudiLing.load_S_matrix("S_train.txt")
    S_val_load, Words = JudiLing.load_S_matrix("S_val.txt")

    @test S_train == S_train_load
    @test S_val == S_val_load

    rm("S_train.txt", force = true, recursive = true)
    rm("S_val.txt", force = true, recursive = true)
end
